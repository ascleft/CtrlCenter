package com.ltyx.core.action.moudle;
...
public class MoudleLogMgrREQ2DB2QS extends ZCBaseActionSupportPlugin {

	JSONObject order = null;
	JSONArray list = null;

	public MoudleLogMgrREQ2DB2QS(HttpServletRequest req) {
		this.request = req;
	}
