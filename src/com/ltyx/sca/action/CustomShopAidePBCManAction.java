...
import com.ltyx.sca.moudle.MoudleCSAGetPriceManPBC;
import com.ltyx.sca.moudle.MoudleCSAOrderManPBC;
...
public class CustomShopAidePBCManAction extends CCActionSupport {
	...
	public String getPrice() {
		...
		init(true);
		String methodName = "客户经理 客供男装 报价";
	...
	public String submit() {
		...
		init(true);
		String methodName = "客户经理 客供男装 提交购物车";
	...
	public boolean doGetPrice() {
		...
		{// 报价
			MoudleCSAGetPriceManPBC moudle = new MoudleCSAGetPriceManPBC(request);
	...
	public boolean doSubmit() {
		...
		{// 提交EC
			MoudleCSAOrderManPBC moudle = new MoudleCSAOrderManPBC(request);
			moudle.prepDBLog(dbLog);
			boolean isSucc = runMoudle(moudle);
			dbLog = moudle.syncDBLog();
			if (isSucc == false) {
