...
public class MoudleCSAGetPriceWomanPBC extends ZCBaseActionSupportPlugin {

	public MoudleCSAGetPriceWomanPBC(HttpServletRequest req) {
		this.name = "客户经理 客供女装 报价";
		this.request = req;
	}
	...
	public boolean doJobs() {
		...
		String httpResp = ZCHttpReqSender.sendGet(ConfigHelperURL.Url_customshopaide_get_price_woman_pbc.getUrl(), param, TextLogHelper.Type.USKIN_AIDE_PRICE_NSRC);
