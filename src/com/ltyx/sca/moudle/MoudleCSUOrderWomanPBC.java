...
public class MoudleCSUOrderWomanPBC extends ZCBaseActionSupportPlugin {

	public MoudleCSUOrderWomanPBC(HttpServletRequest req) {
		this.name = "定制店 客供女装 提交购物车";
		this.request = req;
	}
	...
	public boolean doJobs() {
		...
		Log.Nano.tag(ConfigHelperURL.Url_customshop_add_cart_woman_pbc.getDesc() + "Resp From EC", httpResp);

		timer.stop(null);
		log.ec.addSrcReq(ConfigHelperURL.Url_customshop_add_cart_woman_pbc.getUrl(), param);
