...
public class MoudleCSAGetPriceManPBYX extends ZCBaseActionSupportPlugin {
	...
	public boolean doJobs() {
		...
		String httpResp = ZCHttpReqSender.sendGet(ConfigHelperURL.Url_customshopaide_get_price_man_pbyx.getUrl(), param);
		...
		try {
			...
			Log.Nano.tag(ConfigHelperURL.Url_customshopaide_get_price_man_pbyx.getDesc() + "Resp From EC", httpResp);
