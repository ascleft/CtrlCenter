...
public class MoudleCSSubmitECWoman extends ZCBaseActionSupportPlugin {

	public MoudleCSSubmitECWoman(HttpServletRequest req) {
		this.request = req;
	}
	...
	public boolean doJobs() {
		...
		String httpResp = ZCHttpReqSender.sendGet(ConfigHelperURL.Url_customshop_add_cart_woman.getUrl(), param, LogType.LTYX_USKIN_USER_ALL);
