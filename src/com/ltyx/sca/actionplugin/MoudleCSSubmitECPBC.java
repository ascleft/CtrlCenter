...
public class MoudleCSSubmitECPBC extends ZCBaseActionSupportPlugin {

	public MoudleCSSubmitECPBC(HttpServletRequest req) {
		this.request = req;
	}
	...
	public boolean doJobs() {
		...
		String httpResp = ZCHttpReqSender.sendGet(ConfigHelperURL.Url_customshop_add_cart_pbc.getUrl(), param, LogType.LTYX_USKIN_USER_ALL);
