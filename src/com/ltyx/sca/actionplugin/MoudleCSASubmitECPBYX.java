...
public class MoudleCSASubmitECPBYX extends ZCBaseActionSupportPlugin {

	public MoudleCSASubmitECPBYX(HttpServletRequest req) {
		this.request = req;
	}
	...
	public boolean doJobs() {
		...
		String httpResp = ZCHttpReqSender.sendGet(ConfigHelperURL.Url_customshopaide_add_cart_pbyx.getUrl(), param, LogType.LTYX_USKIN_AIDE_ALL);
