...
public class MoudleCSGetPricePBYX extends ZCBaseActionSupportPlugin {

	public MoudleCSGetPricePBYX(HttpServletRequest req) {
		this.request = req;
	}
	...
	public boolean doJobs() {
		...
		String httpResp = ZCHttpReqSender.sendGet(ConfigHelperURL.Url_customshop_get_price_pbyx, param);
