...
public class MoudleCSSubmitECWomanPBC extends ZCBaseActionSupportPlugin {

	public MoudleCSSubmitECWomanPBC(HttpServletRequest req) {
		this.request = req;
	}
	...
	public boolean doJobs() {
		...
		String httpResp = ZCHttpReqSender.sendGet(ConfigHelperURL.Url_customshop_add_cart_pbc_woman.getUrl(), param, LogType.LTYX_USKIN_USER_ALL);
