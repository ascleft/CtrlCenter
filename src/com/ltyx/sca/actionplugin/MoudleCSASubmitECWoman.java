...
public class MoudleCSASubmitECWoman extends ZCBaseActionSupportPlugin {

	public MoudleCSASubmitECWoman(HttpServletRequest req) {
		this.request = req;
	}
	...
	public boolean doJobs() {
		...
		String httpResp = ZCHttpReqSender.sendGet(ConfigHelperURL.Url_customshopaide_add_cart_woman.getUrl(), param, LogType.LTYX_USKIN_AIDE_ALL);
