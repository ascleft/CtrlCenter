...
public class MoudleCSAGetPriceWoman extends ZCBaseActionSupportPlugin {

	public MoudleCSAGetPriceWoman(HttpServletRequest req) {
		this.request = req;
	}
	...
	public boolean doJobs() {
		...
		String httpResp = ZCHttpReqSender.sendGet(ConfigHelperURL.Url_customshopaide_get_price_woman.getUrl(), param);
