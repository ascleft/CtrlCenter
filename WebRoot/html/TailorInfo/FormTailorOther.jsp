	...
	<head>
		...
		<script type="application/javascript">
			...
			function update() {
				...
				//				面料领标
				preview_3.innerHTML = formMsgs.slice(10, 13);
				//				尺寸
	...
	<body>
		...
		<nav class="teal" role="navigation">
			<div class="nav-wrapper container">
				...
				<a id="logo-container" href="#" class="brand-logo white-text">其他商品</a>
					...
					<div class="row">
						<div class="col s12 m12 l12">
							...
							<ul class="collapsible teal lighten-5" data-collapsible="accordion">
								...
								<li>
									<div class="collapsible-header">
										<i class="material-icons">view_carousel</i>商品、包装
									</div>
									<div class="collapsible-body">
										<div class="row">

											<div class="col s12 m14 l4" style="display: none;">
												<div class="input-field">
													<input type="text" class="validate" name="uskin_code" value="设计师推荐款"> <label>面料编号（USKIN 编号）</label>
												</div>
											</div>
									...
									<div class="collapsible-body">
										<div class="row">
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="ling_wei" value="0">
													<label>领围</label>
												</div>
											</div>
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="xiong_wei" value="0">
													<label>胸围</label>
												</div>
											</div>
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="yao_wei" value="0">
													<label>腰围</label>
												</div>
											</div>
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="du_wei" value="0">
													<label>肚围</label>
												</div>
											</div>
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="dibian" value="0">
													<label>底边</label>
												</div>
											</div>
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="houshen_chang" value="0">
													<label>后身长</label>
												</div>
											</div>
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="jian_kuan" value="0">
													<label>肩宽</label>
												</div>
											</div>
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="jian_kuan_qian" value="0">
													<label>前肩宽</label>
												</div>
											</div>
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="xiu_chang_zuo" value="0">
													<label>袖长左</label>
												</div>
											</div>
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="xiu_chang_you" value="0">
													<label>袖长右</label>
												</div>
											</div>
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="xiutouchang_zuo" value="0">
													<label>左袖头长</label>
												</div>
											</div>
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="xiutouchang_you" value="0">
													<label>右袖头长</label>
												</div>
											</div>
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="xiu_fei" value="0">
													<label>袖肥</label>
												</div>
											</div>
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="xiuzhou_fei" value="0">
													<label>袖肘肥</label>
												</div>
											</div>
											...
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="qianshen_chang" value="0">
													<label>前身长</label>
												</div>
											</div>
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="qianxiong_kuan" value="0">
													<label>前胸宽</label>
												</div>
											</div>
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="houbei_kuan" value="0">
													<label>后背宽</label>
												</div>
											</div>
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="duanxiu_chang" value="0">
													<label>短袖长</label>
												</div>
											</div>
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="duanxiu_kouwei_zuo" value="0">
													<label>短袖口围左</label>
												</div>
											</div>
											<div class="col s6 m4 l3">
												<div class="input-field">
													<input type="number" class="validate" name="duanxiu_kouwei_you" value="0">
													<label>短袖口围右</label>
												</div>
											</div>
											<div class="col s6 m4 l3">
