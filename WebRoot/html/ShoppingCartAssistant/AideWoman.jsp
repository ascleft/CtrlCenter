...
<html>
	...
	<head>
		...
		<script type="application/javascript">
			...
			//url定义
			var url_addShoppingCart = "/CtrlCenter/LTYX/SCA/Main/SubmitAideWoman.action";
			var url_getPrice = "/CtrlCenter/LTYX/SCA/Main/GetPriceAideWoman.action";
		...
		<header>
			<nav class="teal" role="navigation">
				<div class="nav-wrapper container">
					<!-- 页面标题  -->
					<a id="logo-container " href="#" class="brand-logo white-text ">定制顾问 女装</a>
					<!-- 导航菜单键（运动移动设备） -->
