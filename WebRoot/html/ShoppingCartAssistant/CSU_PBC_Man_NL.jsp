...
<html>
	...
	<head>
		...
		<script type="application/javascript">
			...
			//url定义
			var url_price = "/CtrlCenter/LTYX/SCA/Main/CustomShopPBCManGetPrice.action";
			var url_check = "/CtrlCenter/LTYX/SCA/Main/CustomShopPBCManCheck.action";
			var url_addsc = "/CtrlCenter/LTYX/SCA/Main/CustomShopPBCManSubmit.action";
		...
		<header>
			<nav class="red" role="navigation">
				<div class="nav-wrapper container">
					<!-- 页面标题  -->
					<a id="logo-container " href="#" class="brand-logo white-text ">定制店 客供面料 男装</a>
					<!-- 导航菜单键（运动移动设备） -->
