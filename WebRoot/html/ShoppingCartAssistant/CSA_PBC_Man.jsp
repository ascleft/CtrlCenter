...
<html>
	...
	<head>
		...
		<script type="application/javascript">
			...
			//url定义
			var url_price = "/CtrlCenter/LTYX/SCA/Main/CustomShopAidePBCManGetPrice.action";
			var url_check = "/CtrlCenter/LTYX/SCA/Main/CustomShopAidePBCManCheck.action";
			var url_addsc = "/CtrlCenter/LTYX/SCA/Main/CustomShopAidePBCManSubmit.action";
		...
		<header>
			<nav class="teal" role="navigation">
				<div class="nav-wrapper container">
					<!-- 页面标题  -->
					<a id="logo-container " href="#" class="brand-logo white-text ">客户经理 客供男装</a>
					<!-- 导航菜单键（运动移动设备） -->
		...
		<footer class="page-footer teal">
			...
			<div class="fixed-action-btn toolbar">
				...
				<ul>
					...
					<li class="waves-effect waves-light">
						<a href="www.utailor.com.cn/index.php/cart.html">君奕电脑版</a>
					</li>
					<li class="waves-effect waves-light">
						<a href="www.utailor.com.cn/index.php/wap/cart.html">君奕手机版</a>
					</li>
				</ul>
			</div>
