...
<html>
	...
	<head>
		...
		<script type="application/javascript">
			...
			//url定义
			var url_price = "/CtrlCenter/LTYX/SCA/Main/CustomShopAidePBYXWomanGetPrice.action";
			var url_check = "/CtrlCenter/LTYX/SCA/Main/CustomShopAidePBYXWomanCheck.action";
			var url_addsc = "/CtrlCenter/LTYX/SCA/Main/CustomShopAidePBYXWomanSubmit.action";
		...
		<header>
			<nav class="teal" role="navigation">
				<div class="nav-wrapper container">
					<!-- 页面标题  -->
					<a id="logo-container " href="#" class="brand-logo white-text">客户经理 优纤女装</a>
					<!-- 导航菜单键（运动移动设备） -->
